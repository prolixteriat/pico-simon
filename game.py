...
log.setLevel(hardware.LOG_LEVEL)
...
class Game:
    ...
    def read_colours(self):
        ...
        for n in self.notes:
            ...
            log.info(f'read_colours() - Required: {n}  /  Read: {colour}')
            if (colour != n):
                ok = False
                break
